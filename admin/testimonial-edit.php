...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($name_err) && empty($testimonial_err)){
      ...
      $result = $testimonials->editTestimonial($id,$name,$testimonial);
  
      if($result){
          $_SESSION['return_msg'] = '<div id="flash-msg" class = "alert alert-success" role ="alert"> Testimonial edited successfully</div>';
      } else {
          $_SESSION['return_msg'] = '<div class="alert alert-danger" role="alert">Oops! something went wrong. Please try again.</div>';
      }
                                        ...
                                        <div class="p-5">
                                            <form class="user" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                ...
                                                <div class="form-group<?php echo (!empty($testimonial_err)) ? 'has-error' : ''; ?> row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <textarea name="testimonial" class="form-control" id="testimonial" placeholder="Testimonial" rows="3" required> <?php echo $testimonial; ?> </textarea>                                                   
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-2 mb-3 mb-sm-0">
                                                        <input type="submit" class="btn btn-primary btn-block" value="Edit Testimonial">
                                                    </div>
                                                </div>
